...
accuracy_diabetes = train_super_learner(train_pca, test_pca, train_labels, test_labels,max_iter=1000,cv=5,param_grid=param_grid)
print(f"Test Accuracy on Diabetes Dataset: {accuracy_diabetes}")
...
#     'final_estimator__max_depth': [3, 5]
# }
# accuracy_breast_cancer = train_super_learner(train_pca_df, test_pca_df, label_train, label_test,max_iter=500,cv=3,param_grid=param_grid)
